...
## Explosion
<!-- {% youtube mruCBrgPKAM %} -->
<iframe class="video" src="https://www.youtube.com/embed/FZOZe2eet5Q?controls=1&color=white" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

### 概要
<table>
<tr>
    <td>使用ソフト</td>
    <td>Unreal Engine 5<br>Houdini<br>DaVinci Resolve</td>
</tr>
<tr>
    <td>制作期間</td>
    <td>2ヶ月</td>
...
- VATを活用し1つのメッシュで複数の破片を表現する。（→[VATでの破片表現](#vatでの破片表現)）
- 物理演算を事前に計算し、その点群データをNiagaraで読み込み復元する。（→[物理演算](#物理演算)）
...
爆発の前には溜めの表現として像の赤熱、迸る火花、ルーン文字の凝縮、カメラ揺れを追加しました。
この溜めが開放され爆発する気持ちよさが感じられるように意識しました。
...
コンポジットはDaVinci Resolveで行いました。
白飛びや色の飽和を抑え、暖色寄りの色合いに調整しました。

![DaVinci Resolveカラーページ](/portfolio/images/ueburst-ppnodes.webp)

<br>
{% twtw /portfolio/images/pp_off.webp /portfolio/images/pp_on.webp %}
<br>
{% twtw /portfolio/images/pp_off2.webp /portfolio/images/pp_on2.webp %}
